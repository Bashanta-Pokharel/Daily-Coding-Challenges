// ==============================================================================
// Day 02 - Problem 04: Conditionals and Pattern Matching
// Language: JavaScript
// Daily Coding Practice & Algorithmic Problem Solving
// ==============================================================================

function solveProblem4(inputArray) {
  console.log(`Executing Day 2 Problem 4 ($JavaScript): Conditionals and Pattern Matching`);
  const filtered = inputArray.filter(n => n % 2 === 0).map(n => n * 4);
  const sum = filtered.reduce((acc, curr) => acc + curr, 0);
  return { day: 2, problem: 4, items: filtered, total: sum };
}
