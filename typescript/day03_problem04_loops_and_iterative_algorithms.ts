// ==============================================================================
// Day 03 - Problem 04: Loops and Iterative Algorithms
// Language: TypeScript
// Daily Coding Practice & Algorithmic Problem Solving
// ==============================================================================

function solveProblem4(inputArray) {
  console.log(`Executing Day 3 Problem 4 ($TypeScript): Loops and Iterative Algorithms`);
  const filtered = inputArray.filter(n => n % 2 === 0).map(n => n * 4);
  const sum = filtered.reduce((acc, curr) => acc + curr, 0);
  return { day: 3, problem: 4, items: filtered, total: sum };
}
